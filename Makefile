...
deploy-local:
	$(call deploy_script,script/LocalDeployment.s.sol:LocalDeploymentScript)

deploy-mock-erc20:
	$(call deploy_script,script/MockERC20Deployment.s.sol:MockERC20DeploymentScript)

deploy-sepolia-testnet:
	set -a; source .env.sepolia; set +a; \
	$(call deploy_script,script/TestnetDeployment.s.sol:TestnetDeploymentScript)
node:
