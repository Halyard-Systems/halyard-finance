...
contract TestnetDeploymentScript is Script {
    ...
    address public sepoliaTestnetPyth = 0xDd24F84d36BF92C65F92307595335bdFab5Bbd21;
    ...
    function _getNetworkConfig() internal view returns (address router, uint256 poolId, address usdc, address usdt, address weth) {
    ...
    function run() public {
        ...
        (address stargateRouter, uint256 poolId, address usdcToken, address usdtToken, address wethToken) = _getNetworkConfig();
        ...
        console.log("Network:", vm.envOr("NETWORK", "sepolia"));
        ...
        mockPyth = new MockPyth(validTime, updateFee);
        console.log("MockPyth deployed at:", address(mockPyth));

        // Deploy BorrowManager
        console.log("Deploying BorrowManager...");
        borrowManager = new BorrowManager(address(depositManager), sepoliaTestnetPyth, liquidationThreshold);
