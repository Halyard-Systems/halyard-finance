...
/// @title DeploySpokeBaseSepolia
/// @notice Deploys a BASE spoke on Base Sepolia using the real LayerZero EndpointV2.
...
contract DeploySpokeBaseSepoliaScript is Script {
    function run() public {
        ...
        console.log("=== Deploy BASE Spoke on Base Sepolia ===");
