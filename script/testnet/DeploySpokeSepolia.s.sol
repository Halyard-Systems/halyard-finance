...
/// @title DeploySpokeSepolia
/// @notice Deploys an ETH spoke (SpokeController + CollateralVault + LiquidityVault)
///         on Sepolia using the real LayerZero EndpointV2.
...
contract DeploySpokeSepoliaScript is Script {
    function run() public {
        ...
        console.log("=== Deploy ETH Spoke on Sepolia ===");
